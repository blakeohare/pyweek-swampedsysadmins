...
class ScoreMenu:
	...
	def get_ui_elements(self):
		if self.elements == None:
			...
			elements.append(self.create_grid_element(1, col1, row1, 'green'))
			elements.append(self.create_grid_element(0, col2, row1, 'green'))
			elements.append(self.create_grid_element(0, col3, row1, 'green'))
			
			elements.append(self.create_grid_element(0, col1, row2, 'orange'))
			elements.append(self.create_grid_element(0, col2, row2, 'orange'))
			elements.append(self.create_grid_element(0, col3, row2, 'orange'))
			
			elements.append(self.create_grid_element(0, col1, row3, 'red'))
			elements.append(self.create_grid_element(0, col2, row3, 'red'))
			elements.append(self.create_grid_element(0, col3, row3, 'red'))
